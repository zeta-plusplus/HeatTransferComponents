...
model HTverticalPlate00
  ...
  Modelica.Blocks.Interfaces.RealOutput y_h(quantity = "CoefficientOfHeatTransfer", unit = "W/(m2.K)", displayUnit = "W/(m2.K)") annotation(
    Placement(visible = true, transformation(origin = {110, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-90, 141}, extent = {{7, -7}, {-7, 7}}, rotation = -90)));
  ...
  Modelica.Blocks.Interfaces.RealOutput y_Q_flow(quantity="Power", unit="W", displayUnit="W") annotation(
    Placement(visible = true, transformation(origin = {110, 26}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-60, 141}, extent = {{7, -7}, {-7, 7}}, rotation = -90)));
equation
//
