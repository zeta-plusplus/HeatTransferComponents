...
model HTverticalPlate01
  ...
  Modelica.Blocks.Interfaces.RealInput u_khconv annotation(
    Placement(visible = true, transformation(origin = {-110, -60}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-97, -75}, extent = {{-9, -9}, {9, 9}}, rotation = 0)));
equation
//
...
//
  ...
  Icon(graphics = {Text(origin = {90, 20}, rotation = -90, extent = {{-120, 10}, {120, -10}}, textString = "%name"), Line(origin = {-99.401, 15.5933}, points = {{44, -16}, {0, -16}}, color = {255, 0, 0}, thickness = 4), Rectangle(origin = {-53, 18}, fillColor = {0, 0, 127}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-7, 118}, {7, -118}}), Line(origin = {-24.18, -34.18}, points = {{-11.8178, -51.8178}, {2.18219, -35.8178}, {8.18219, 2.18219}, {8.18219, 46.1822}}, arrow = {Arrow.None, Arrow.Open}), Line(origin = {27.2, -36.2}, points = {{10.7958, -47.7958}, {-1.2042, -37.7958}, {-11.2042, 2.2042}, {-11.2042, 48.2042}}, arrow = {Arrow.None, Arrow.Open}), Line(origin = {1, -37}, points = {{-1, -43}, {-1, 49}}, arrow = {Arrow.None, Arrow.Open}), Line(origin = {-32.2247, 129.413}, points = {{-18, -9}, {12, -9}}, color = {255, 0, 0}, arrow = {Arrow.None, Arrow.Open}, arrowSize = 5), Line(origin = {-32.2247, 109.413}, points = {{-18, -9}, {12, -9}}, color = {255, 0, 0}, arrow = {Arrow.None, Arrow.Open}, arrowSize = 5), Line(origin = {-32.2247, 89.413}, points = {{-18, -9}, {12, -9}}, color = {255, 0, 0}, arrow = {Arrow.None, Arrow.Open}, arrowSize = 5), Line(origin = {-32.2247, 69.413}, points = {{-18, -9}, {12, -9}}, color = {255, 0, 0}, arrow = {Arrow.None, Arrow.Open}, arrowSize = 5), Line(origin = {-32.2247, 49.413}, points = {{-18, -9}, {12, -9}}, color = {255, 0, 0}, arrow = {Arrow.None, Arrow.Open}, arrowSize = 5), Line(origin = {-32.2247, 29.413}, points = {{-18, -9}, {12, -9}}, color = {255, 0, 0}, arrow = {Arrow.None, Arrow.Open}, arrowSize = 5), Line(origin = {-32.2247, 9.413}, points = {{-18, -9}, {12, -9}}, color = {255, 0, 0}, arrow = {Arrow.None, Arrow.Open}, arrowSize = 5), Line(origin = {-32.2247, -10.587}, points = {{-18, -9}, {12, -9}}, color = {255, 0, 0}, arrow = {Arrow.None, Arrow.Open}, arrowSize = 5), Line(origin = {-32.2247, -30.587}, points = {{-18, -9}, {12, -9}}, color = {255, 0, 0}, arrow = {Arrow.None, Arrow.Open}, arrowSize = 5), Line(origin = {-32.2247, -50.587}, points = {{-18, -9}, {12, -9}}, color = {255, 0, 0}, arrow = {Arrow.None, Arrow.Open}, arrowSize = 5), Line(origin = {-32.2247, -70.587}, points = {{-18, -9}, {12, -9}}, color = {255, 0, 0}, arrow = {Arrow.None, Arrow.Open}, arrowSize = 5), Line(origin = {-32.2247, -90.587}, points = {{-18, -9}, {12, -9}}, color = {255, 0, 0}, arrow = {Arrow.None, Arrow.Open}, arrowSize = 5), Line(origin = {-21.0993, -42.5877}, points = {{-72, -33}, {-2, 95}}, thickness = 1.5, arrow = {Arrow.None, Arrow.Open}, arrowSize = 6)}, coordinateSystem(extent = {{-100, -100}, {100, 140}})),
  Diagram(coordinateSystem(extent = {{-100, -100}, {100, 140}})));
end HTverticalPlate01;
