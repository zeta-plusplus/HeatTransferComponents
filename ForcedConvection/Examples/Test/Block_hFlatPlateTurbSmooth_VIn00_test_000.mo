...
model Block_hFlatPlateTurbSmooth_VIn00_test_000
  ...
  HeatTransferComponents.ForcedConvection.Block_hFlatPlateTurbSmooth_VIn00 calc_hConv(redeclare package Medium = gas1) annotation(
...
equation
  ...
  connect(ramp_V.y, calc_hConv.u_V) annotation(
    Line(points = {{-34, 48}, {-28, 48}, {-28, 16}, {-20, 16}}, color = {0, 0, 127}));
...
end Block_hFlatPlateTurbSmooth_VIn00_test_000;
