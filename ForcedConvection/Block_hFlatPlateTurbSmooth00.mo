...
//----------------------------------------
  ...
  // interface
  //----------------------------------------
  Modelica.Blocks.Interfaces.RealOutput y_h(start= 100, quantity= "CoefficientOfHeatTransfer", unit="W/(m2.K)", displayUnit="W/(m2.K)") annotation(
...
//
  ...
  Re= Medium.density(Medium.setState_pTX(fluid.p, T_bulkMean, fluid.X))*Vel*Len/mu_b;
//
